...
CREATE TABLE [MANA].[SESSION_STATUSES] (
    [SESSION_STATUS_ID] TINYINT,
    [NOTE]              NCHAR(128),
    CONSTRAINT PK_SESSION_STATUSES PRIMARY KEY (SESSION_STATUS_ID)
);

CREATE TABLE [MANA].[USER_SESSIONS] (
    [SESSION_ID]        BIGINT,
    [USER_ID]           CHAR(16)        NOT NULL,
    [ACCOUNT_ID]        CHAR(16)        NOT NULL,
    [FRONT_ID]          SMALLINT,
    [CONNECT_TIME]      DATETIMEOFFSET  NOT NULL,
    [LOGIN_TIME]        DATETIMEOFFSET,
    [LOGOUT_TIME]       DATETIMEOFFSET,
    [DISCONNECT_TIME]   DATETIMEOFFSET,
    [SESSION_STATUS_ID] TINYINT,
    CONSTRAINT PK_SESSIONS PRIMARY KEY (SESSION_ID),
    CONSTRAINT FK_SESSIONS_FRONTS FOREIGN KEY (FRONT_ID)            REFERENCES [MANA].[FRONTS] (FRONT_ID),
    CONSTRAINT FK_SESSIONS_STATUS FOREIGN KEY (SESSION_STATUS_ID)   REFERENCES [MANA].[SESSION_STATUSES] (SESSION_STATUS_ID)
);
...
CREATE TABLE [MANA].[INPUT_ORDERS](
    ...
    CONSTRAINT FK_INPUT_SESSION     FOREIGN KEY (SESSION_ID)    REFERENCES [MANA].[USER_SESSIONS] (SESSION_ID),
